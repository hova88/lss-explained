...
export const metadata: Metadata = {
  ...
  title: "LSS Explained — A Spatial Whiteboard from Pixels to BEV",
  description: "A content-first twelve-scene course and interactive geometry lab for the original Lift-Splat-Shoot camera-to-BEV model, grounded in one real nuScenes frame.",
