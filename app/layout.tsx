...
export const metadata: Metadata = {
  ...
  description: "An eight-scene tensor walkthrough of the LSS camera-to-BEV contract, geometry, pooling and supervision, contrasted with BEVDepth on one real nuScenes frame.",
