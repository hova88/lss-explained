...
export function LssScene(props: {
  ...
  const showRig=props.sceneIndex>=2&&props.sceneIndex<=6,showRay=props.sceneIndex>=4&&props.sceneIndex<=6,showBev=props.sceneIndex>=7,showTruth=props.sceneIndex===10,showShoot=props.sceneIndex===11;
